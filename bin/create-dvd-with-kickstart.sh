...
mkisofs -o $DEST -b isolinux/isolinux.bin -c isolinux/boot.cat -joliet-long -no-emul-boot -boot-load-size 4 -boot-info-table -quiet -R -J -v -T $DIR/tmp/kickstart-dvd2 
